...
<template>
    <div class="container mx-auto">
        <div class="container mx-auto flex justify-between items-center">
            <h2 class="text-2xl font-bold mb-4 text-green-700">Size Index</h2>
            <router-link :to="{ name: 'size.create' }" class="btn-add-size">
            ...
            <table class="min-w-full bg-white border border-green-300">
                <thead>
                    <tr>
                        ...
                        <th class="py-3 px-6 text-left border-b text-green-700">Size Name</th>
                ...
                <tbody>
                    <tr v-for="(size, index) in sizes" :key="size.id">
                        ...
                        <td class="py-4 px-6 border-b">{{ size.name }}</td>
                        <td class="py-4 px-6 border-b">
                            <div class="flex items-center">
                                <router-link :to="{ name: 'size.edit', params: { id: size.id } }"
