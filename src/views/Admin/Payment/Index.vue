            ...
            <table class="min-w-full bg-white border border-green-300">
                <thead>
                    <tr>
                        ...
                        <th class="py-3 px-6 text-left border-b text-green-700 w-1/2">Image</th>
                        <th class="py-3 px-6 text-left border-b text-green-700 w-1/2">Payment Name</th>
                ...
                <tbody>
                    <tr v-for="(payment, index) in payments" :key="payment.id">
                        ...
                        <td class="py-4 px-6 border-b"><img :src="'/uploaded/'+payment.image" :alt="payment.image" /></td>
